...
public class SentSolvedProblemDetailsFragment extends Fragment implements OnMapReadyCallback {
    ...
    public SentSolvedProblemDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_sent_solved_problem_details, container, false);
    }
